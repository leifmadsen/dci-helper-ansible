...
# Portions of this code came from the following URL. See for more information.
...
class Runner(object):
    ...
    def __init__(self, playbook, inventory_file, run_data={}, become_pass=None, verbosity=0, options=None):
